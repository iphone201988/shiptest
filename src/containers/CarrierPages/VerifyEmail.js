...
class VerifyEmail extends Component {
  ...
  onVerifyEmail = (values) => {
    ...
    this.props.firebase.auth().applyActionCode(oobCode).then(res => {
      notifySuccess("notification.success.email_verified", this.props.intl)
      ...
      notifyError("notification.fail.email_verified", this.props.intl)
      this.loading(false)
      console.log(e)
    })   
  }
