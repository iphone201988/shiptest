...
class ShippersAccount extends PureComponent {
...
KeyValListToOptions = (KeyValList) => {
              ...
              items: [
                {
                  ...
                  fieldProps: {
                    placweholder: this.props.intl.formatMessage({ id: "general.account_status" }),
                ...
                },
                {
                  ...
                  fieldProps: {
                    placweholder: this.props.intl.formatMessage({ id: "general.company_name" }),
                  },
                  wrapperCol: LocationFilterWrapperCol
                },
              ]
  ...
  render() {
    const {company,columns, itemActions, viewType, queryFilterConditions, resultsFilterConditions } = this.state ;
    ...
    if((columns || []).length > 0){
      ...
      return (
         <div>
          ...
          <DataView itemType={"shipper_account"}
