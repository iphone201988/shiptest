...
class ShipperNewTrailer extends Component {
      ...
      sections: [
        {
          ...
          groups:[
            ...
            },
            {
              ...
              groupWrapper:{
                type: "box",
                props: {size: "small", title: this.props.intl.formatMessage({id:"general.dimensions"})},
              },
              items:[
                {
                  name: "length",
...
ShipperNewTrailer.propTypes = {
  intl: intlShape.isRequired
}

export default compose(connect(), firebaseConnect())(injectIntl(ShipperNewTrailer))