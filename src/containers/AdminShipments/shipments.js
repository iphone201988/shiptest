...
class Shipments extends PureComponent {
    ...
    setFilterConditions = (formValues = {}) => {
        ...
        this.setState(setShipmentFilter(formValues, view, "admin", "shipment", "carrier"))
    }
    ...
    getColumns = () => {
        return  [
            ...
            {
                title: this.props.intl.formatMessage({id: "general.company_name"}),
                dataIndex: '',
                rowKey: 'company_name',
                width: '15%',
                render: (text, shipment) => <div>{shipment.shipper}</div>,
            },
            {
    ...
    getItemActions = () => {
        return [
            ...
            {label: "general.update", confirm_text:"shipment.update_confirm", type:"confirm", callback:this.updateShipmentStatus}
        ]
    }
    ...
    render(){
        ...
        const {queryFilterConditions, resultsFilterConditions, columns, itemActions, viewType} = this.state
        ...
        if ((columns || []).length > 0){
            return (
                <div>
                    ...
                    />
                    <DataView itemType={"admin_shipment"}
                              queryFilterConditions={queryFilterConditions}
                              resultsFilterConditions={resultsFilterConditions}
                              columns={columns}
                              itemActions={itemActions}
                              viewType={viewType}
                              hasLocationFilters={'destination.location.displayPosition.geohash'}
