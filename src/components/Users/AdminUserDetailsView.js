...
import User from "model/user/admin_user";
...
class AdminUserDetailsView extends React.Component {
		...
		return (
			<div>
				<Box>
					<RadioGroup
						buttonStyle="solid"
						id="CarrierUserDetails"
						name="CarrierUserDetails"
						value={detailsView}
						onChange={event => {
...
AdminUserDetailsView.propTypes = {
  intl: intlShape.isRequired
}

export default injectIntl(AdminUserDetailsView)